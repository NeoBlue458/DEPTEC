  ...
  <main class="main-layout">
    <section class="panel">
      ...
      <div class="table-area">
        <!-- Aquí se mostrará la tabla de servicios -->
      </div>
      ...
      <form id="formAgregarServicio">
        <div class="inputs">
          <div class="input-group">
            <label for="nombreAgregarServicio">Nombre</label>
            <input type="text" id="nombreAgregarServicio" placeholder="Ej. Internet" required>
          </div>
          <div class="input-group small">
            <label for="precioAgregarServicio">Precio</label>
            <input type="number" id="precioAgregarServicio" placeholder="Ej. 1500" required>
          </div>
        </div>
        <div class="modal-actions">
          <button type="submit" class="btn brown"><i class="fa-solid fa-plus"></i> Agregar</button>
          <button type="button" class="btn black" onclick="cerrarModal('modalAgregarServicio')"><i class="fa-solid fa-right-from-bracket"></i> Volver</button>
        </div>
      </form>
    </div>
  </div>
