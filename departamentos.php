    ...
    $(document).ready(function() {
      ...
      $('#btnEliminar').on('click', function() {
        ...
        if (confirm(`¿Está seguro de que desea eliminar el departamento con ID: ${idSeleccionado}? Esta acción es irreversible.`)) {
          ...
          $.ajax({
            url: '../eliminar_registro.php', // El script que creamos
            type: 'POST',
            data: { id: idSeleccionado },
            dataType: 'json',
            success: function(response) {
      ...
      $('#formEditar').on('submit', function(e) {
        ...
        $.ajax({
          url: '../update_departamentos.php', // Asume que este script también manejará la lógica de UPDATE
          type: 'POST',
          data: formData,
          success: function(response) {
            // Asume que 'update_departamentos.php' redirige o devuelve una respuesta
            alert('Departamento modificado con éxito. Recargando página...');
